...
class Solver(AbstractSolver):
    ...
    def solve_1_internal(self, input_string):
        return self.solve(input_string, len(input_string) - 1, 1, True)

    def solve_2_internal(self, input_string):
        return self.solve(input_string, len(input_string) / 2, len(input_string) / 2, False)

    def solve(self, input_string, range_upper_bound, second_digit_index_offset, include_circular):
        result = 0
